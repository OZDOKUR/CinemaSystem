...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240721094825_PrivilegedHallName2")]
    partial class PrivilegedHallName2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.MovieTheater", b =>
                {
                    ...
                    b.Property<int>("PrivilegedHallId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Concrete.PrivilegedHall", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Concrete.MovieTheater", b =>
                {
                    b.HasOne("Entities.Concrete.PrivilegedHall", "PrivilegedHall")
                        .WithMany("MovieTheaters")
                        .HasForeignKey("PrivilegedHallId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PrivilegedHall");
                });
